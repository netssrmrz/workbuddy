...
{
  public static final String SETTING_KEY_HOURLY_RATE="hourly_rate";
	public static final String SETTING_KEY_CURRENCY_SYMBOL="currency_symbol";
	public static final String SETTING_KEY_ROUND_TO="round_to";

  public android.preference.PreferenceScreen ps;

	android.preference.EditTextPreference hr_rate;
	android.preference.EditTextPreference curr_pref;
  ...
  public void onCreate(android.os.Bundle savedInstanceState) 
  {
		...
		{
			rs.android.Util.Show_Error(this, err);
		}
  }
